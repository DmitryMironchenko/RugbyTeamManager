...
class ChartWeb extends Component {
			...
			init:`<html>
				...
				: ''}
                        ...
                        $(function () {
                            ...
                            window.chart = Highcharts.${this.props.stock ? 'stockChart' : 'chart'}('container', `,
			end:`           );
                        });
                        </script>
                    </head>
	...
	componentWillReceiveProps(newProps) {
		// this.refs.webViewBridge.sendToBridge(JSON.stringify(newProps.data));
		this.webView.injectJavaScript(`
			(function () {
				window.chart.series[0].addPoint([Date.now(), ${newProps.data}]);
			})();
		`);
